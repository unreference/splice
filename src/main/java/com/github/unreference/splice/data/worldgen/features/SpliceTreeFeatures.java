...
import com.github.unreference.splice.world.level.levelgen.feature.treedecorators.SpliceCreakingHeartDecorator;
...
public final class SpliceTreeFeatures {
  ...
  public static final ResourceKey<ConfiguredFeature<?, ?>> PALE_OAK_CREAKING_HEART =
  ...
  public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
    ...
    SpliceFeatureUtils.register(
        context, PALE_OAK_CREAKING_HEART, Feature.TREE, paleOakCreakingHeart().build());
  }
  ...
  private static TreeConfiguration.TreeConfigurationBuilder paleOakCreakingHeart() {
    return new TreeConfiguration.TreeConfigurationBuilder(
            BlockStateProvider.simple(SpliceBlocks.PALE_OAK_LOG.get()),
            new DarkOakTrunkPlacer(6, 2, 1),
            BlockStateProvider.simple(SpliceBlocks.PALE_OAK_LEAVES.get()),
        ...
        .decorators(
            ImmutableList.of(
                new SplicePaleMossDecorator(0.15f, 0.4f, 0.8f),
                new SpliceCreakingHeartDecorator(1.0f)))
        .ignoreVines();
  }
}
