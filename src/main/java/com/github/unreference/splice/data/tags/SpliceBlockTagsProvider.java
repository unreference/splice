...
public final class SpliceBlockTagsProvider extends BlockTagsProvider {
  ...
  protected void addTags(HolderLookup.@NotNull Provider provider) {
    ...
    this.tag(SpliceBlockTags.COPPER_CHESTS)
        ...
        .add(SpliceBlocks.WAXED_COPPER_CHEST.get())
        .add(SpliceBlocks.WAXED_EXPOSED_COPPER_CHEST.get())
        .add(SpliceBlocks.WAXED_WEATHERED_COPPER_CHEST.get())
        .add(SpliceBlocks.WAXED_OXIDIZED_COPPER_CHEST.get());
